 ...
 * @since 1.0.0
 */
class Shree_Author_Widget extends WP_Widget{
     public function __construct(){
          parent::__construct(
               'shree-author-widget',
               __( 'CT Author', 'shree' ),
               array( 'description' => __( 'Place anywhere in the Widget area.', 'shree' ) )
          );
     }   
     public function widget( $args, $instance ){
        if(!empty($instance)){ 
         ...
         $youtube     = $instance['youtube'];
          ...
          {
          ?>
              <section  class="widget author-widget">Montserrat, sans-serif
                  ...
                  ?>
                  <?php //echo $args['']; //why index is empty? ?>
                     <?php if(isset($title)) { 
     ...
     public function form($instance ){
          ?>
          <p>
              <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Author or Ads Title', 'shree' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo $this->get_field_id('description'); ?>"><?php _e( 'Author or Ads Description', 'shree' ); ?></label><br />
              ...
              <p>
                 ...
                 <input type="text" class="widefat custom_media_url" name="<?php echo $this->get_field_name('image_uri'); ?>" id="<?php echo $this->get_field_id('image_uri'); ?>" value="<?php 
                  ...
                  ?>">
                 <input type="button" class="button button-primary custom_media_button" id="custom_media_button" name="<?php echo $this->get_field_name('image_uri'); ?>" value="<?php esc_attr_e('Upload Image','shree')?>" />
             </p>
             <p>
                <label for="<?php echo esc_attr( $this->get_field_id('facebook') ); ?>"><?php _e( 'Facebook', 'shree' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('twitter') ); ?>"><?php _e( 'Twitter', 'shree' ); ?></label><br />
         ...
         <p>
                <label for="<?php echo esc_attr( $this->get_field_id('googleplus') ); ?>"><?php _e( 'Google Plus', 'shree' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('instagram') ); ?>"><?php _e( 'Instagram', 'shree' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('linkedin') ); ?>"><?php _e( 'Linkedin', 'shree' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('youtube') ); ?>"><?php _e( 'Youtube', 'shree' ); ?></label><br />
...
add_action( 'widgets_init', 'shree_author_widget' ); 
function shree_author_widget(){     
    register_widget( 'Shree_Author_Widget' );
}
